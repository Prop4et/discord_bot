...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('backward')
		.setDescription('backwards the song of a number of seconds')
        .addIntegerOption(option =>
            option
                .setName('time')
                .setDescription('the amount of seconds to fbw')
                .setMinValue(0)
                .setRequired(true)),
	async execute(interaction) { 
        ...
        if(success){
            ...
            .setURL(track.url)
            .setDescription(`⏪ Song backwards by ${time} seconds`)
